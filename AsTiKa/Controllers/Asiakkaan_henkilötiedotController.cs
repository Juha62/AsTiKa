...
namespace AsTiKa.Controllers
{
    public class Asiakkaan_henkilötiedotController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Asiakkaan_lähiomaiset,Laskutustiedot,Yleinen_edunvalvoja,Muuttotiedot,Muut_tiedot,Perustiedot")] Asiakkaan_henkilötiedot asiakkaan_henkilötiedot)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Asiakkaan_lähiomaiset,Laskutustiedot,Yleinen_edunvalvoja,Muuttotiedot,Muut_tiedot,Perustiedot")] Asiakkaan_henkilötiedot asiakkaan_henkilötiedot)
        {
            if (ModelState.IsValid)
            {
