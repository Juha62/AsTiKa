...
namespace AsTiKa.Controllers
{
    public class Asiakkaan_hoitotiedotController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Asukkaan_perustiedot,Edunvalvojan_yhteystiedot,Omahoitajan_yhteystiedot,Hoitavan_lääkärin_yhteystiedot,Omaisten_yhteystiedot,Diagnoosit,Allergiat,Kontrolloitavat_laboratoriokokeet,Sovitut_ja_suunnitellut_kontrollikäynnit,Syöminen_erityisruokavalio,Liikkuminen__hygienia,Ihon_kunto,Erityishoidot,Kommunikointi,Psyykkinen_vointi,Hoitoon_hakeutumisen_syy")] Asiakkaan_hoitotiedot asiakkaan_hoitotiedot)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Asukkaan_perustiedot,Edunvalvojan_yhteystiedot,Omahoitajan_yhteystiedot,Hoitavan_lääkärin_yhteystiedot,Omaisten_yhteystiedot,Diagnoosit,Allergiat,Kontrolloitavat_laboratoriokokeet,Sovitut_ja_suunnitellut_kontrollikäynnit,Syöminen_erityisruokavalio,Liikkuminen__hygienia,Ihon_kunto,Erityishoidot,Kommunikointi,Psyykkinen_vointi,Hoitoon_hakeutumisen_syy")] Asiakkaan_hoitotiedot asiakkaan_hoitotiedot)
        {
            if (ModelState.IsValid)
            {
