...
namespace AsTiKa.Controllers
{
    public class Asiakkaan_omaisuuController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Henkilökohtaiset_tavarat,Huonekalut,Tekstiilit,Vuode_ja_liinavaatteet")] Asiakkaan_omaisuu asiakkaan_omaisuu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Henkilökohtaiset_tavarat,Huonekalut,Tekstiilit,Vuode_ja_liinavaatteet")] Asiakkaan_omaisuu asiakkaan_omaisuu)
        {
            if (ModelState.IsValid)
            {
