...
namespace AsTiKa.Controllers
{
    public class Asiakkaan_rahan_käyttöController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Saldo,Nostot,Päiväys,Määrä,Käyttötarkoitus,Kuittaaja")] Asiakkaan_rahan_käyttö asiakkaan_rahan_käyttö)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Saldo,Nostot,Päiväys,Määrä,Käyttötarkoitus,Kuittaaja")] Asiakkaan_rahan_käyttö asiakkaan_rahan_käyttö)
        {
            if (ModelState.IsValid)
            {
