...
namespace AsTiKa.Controllers
{
    public class Infektion_seuranta_ja_hoitoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Milloin_infektio_todettu,Infektion_tyyppi,Oireet,Hoito,Mahdolliset_kontrollit")] Infektion_seuranta_ja_hoito infektion_seuranta_ja_hoito)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Milloin_infektio_todettu,Infektion_tyyppi,Oireet,Hoito,Mahdolliset_kontrollit")] Infektion_seuranta_ja_hoito infektion_seuranta_ja_hoito)
        {
            if (ModelState.IsValid)
            {
