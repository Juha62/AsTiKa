...
namespace AsTiKa.Controllers
{
    public class LääkelistaController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Nykyhetken_lääkitys,Lääkitys_historia")] Lääkelista lääkelista)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Nykyhetken_lääkitys,Lääkitys_historia")] Lääkelista lääkelista)
        {
            if (ModelState.IsValid)
            {
