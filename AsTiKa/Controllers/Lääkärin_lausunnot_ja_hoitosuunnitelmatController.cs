...
namespace AsTiKa.Controllers
{
    public class Lääkärin_lausunnot_ja_hoitosuunnitelmatController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Psykiatrian_lausunnot_ja_hoitosuunnitelmat,Neurologian_lausunnot_ja_hoitosuunnitelmat,Yleislääketied_lausunnot_ja_hoitosuunnitelmat")] Lääkärin_lausunnot_ja_hoitosuunnitelmat lääkärin_lausunnot_ja_hoitosuunnitelmat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Psykiatrian_lausunnot_ja_hoitosuunnitelmat,Neurologian_lausunnot_ja_hoitosuunnitelmat,Yleislääketied_lausunnot_ja_hoitosuunnitelmat")] Lääkärin_lausunnot_ja_hoitosuunnitelmat lääkärin_lausunnot_ja_hoitosuunnitelmat)
        {
            if (ModelState.IsValid)
            {
