...
namespace AsTiKa.Controllers
{
    public class Muistihoitajan_sivuController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Tehtyjen_testien_tulokset,Käyntikirjaukset_ja_havainnot")] Muistihoitajan_sivu muistihoitajan_sivu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Tehtyjen_testien_tulokset,Käyntikirjaukset_ja_havainnot")] Muistihoitajan_sivu muistihoitajan_sivu)
        {
            if (ModelState.IsValid)
            {
