...
namespace AsTiKa.Controllers
{
    public class Vointi_päiväkirjaController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Hoidon_tarpeen_kirjaaminen,Hoidon_tavoitteiden_kirjaaminen,Hoidon_suunnittelun_kirjaaminen,Hoidon_toteutuksen_kirjaaminen")] Vointi_päiväkirja vointi_päiväkirja)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Hoidon_tarpeen_kirjaaminen,Hoidon_tavoitteiden_kirjaaminen,Hoidon_suunnittelun_kirjaaminen,Hoidon_toteutuksen_kirjaaminen")] Vointi_päiväkirja vointi_päiväkirja)
        {
            if (ModelState.IsValid)
            {
